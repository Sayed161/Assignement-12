...
const TaskDetails = () => {
  ...
  const { Quser, setLoading } = useContext(AuthContext);
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="md:w-2/3">
                  ...
                  <div className="space-y-2">
                    <p>
                      ...
                      <span className="text-[#00E1F9]">
                        ${task?.task?.payable_amount?.toFixed(2)}
                      </span>
                    </p>
                    <p>
                    ...
                    <p>
                      Total budget:{" "}
                      <span className="text-[#00E1F9]">
                        ${task?.task?.total_cost?.toFixed(2)}
                      </span>
                    </p>
                  </div>
                </div>
              ...
              <motion.div
                ...
                className="mt-8"
              >
                <h3 className="text-xl font-semibold mb-4 text-[#00E1F9]">
                  Submit Your Work
                </h3>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#00E1F9]">
                    {task?.task?.created_by?.displayName}
                  </p>
                  <p className="text-sm text-gray-400">
                    {task?.task?.created_by?.email}
                  </p>
                </div>
              </motion.div>
            </div>
